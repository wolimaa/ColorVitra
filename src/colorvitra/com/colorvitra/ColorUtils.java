...
public class ColorUtils {
	...
	private ArrayList<ColorName> initColorList() {
		...
		colorList.add(new ColorName("Água(azul-esverdeado)", 0x00, 0xFF, 0xFF));
		colorList.add(new ColorName("Água-marinha", 0x7F, 0xFF, 0xD4));
		...
		colorList.add(new ColorName("Amêndoa", 0xFF, 0xEB, 0xCD));
		...
		colorList.add(new ColorName("Verde-limão", 0x7F, 0xFF, 0x00));
		...
		colorList.add(new ColorName("Orquídea(magenta) escura", 0x99, 0x32, 0xCC));
		colorList.add(new ColorName("Vermelho escuro", 0x8B, 0x00, 0x00));
		colorList.add(new ColorName("Salmão escuro", 0xE9, 0x96, 0x7A));
		colorList.add(new ColorName("Verde mar escuro", 0x8F, 0xBC, 0x8F));
		colorList.add(new ColorName("Azul ardósia escuro", 0x48, 0x3D, 0x8B));
		colorList.add(new ColorName("Cinza ardósia escuro", 0x2F, 0x4F, 0x4F));
		...
		colorList.add(new ColorName("Salmão claro", 0xFF, 0xA0, 0x7A));
		colorList.add(new ColorName("Verde mar claro", 0x20, 0xB2, 0xAA));
		colorList.add(new ColorName("Azul céu claro", 0x87, 0xCE, 0xFA));
		colorList.add(new ColorName("Cinza ardósia claro", 0x77, 0x88, 0x99));
		colorList.add(new ColorName("Azul aço claro", 0xB0, 0xC4, 0xDE));
		...
		colorList.add(new ColorName("Água-marinha-médio", 0x66, 0xCD, 0xAA));
		colorList.add(new ColorName("Azul médio", 0x00, 0x00, 0xCD));
		colorList.add(new ColorName("Orquídia médio", 0xBA, 0x55, 0xD3));
		colorList.add(new ColorName("Roxo médio", 0x93, 0x70, 0xDB));
		colorList.add(new ColorName("Verde mar médio", 0x3C, 0xB3, 0x71));
		colorList.add(new ColorName("Azul ardósia médio", 0x7B, 0x68, 0xEE));
		colorList.add(new ColorName("Verde primavera médio", 0x00, 0xFA, 0x9A));
		colorList.add(new ColorName("Turquesa médio", 0x48, 0xD1, 0xCC));
		colorList.add(new ColorName("Vermelho violeta médio", 0xC7, 0x15, 0x85));
		...
		colorList.add(new ColorName("Orquídea(majenta)", 0xDA, 0x70, 0xD6));
		colorList.add(new ColorName("Dourado pálido", 0xEE, 0xE8, 0xAA));
		colorList.add(new ColorName("Verde pálido", 0x98, 0xFB, 0x98));
		colorList.add(new ColorName("Turquesa pálida", 0xAF, 0xEE, 0xEE));
		...
		colorList.add(new ColorName("Azul pólvara", 0xB0, 0xE0, 0xE6));
		colorList.add(new ColorName("Púrpura", 0x80, 0x00, 0x80));
		...
		colorList.add(new ColorName("Salmão", 0xFA, 0x80, 0x72));
		...
		colorList.add(new ColorName("Azul céu", 0x87, 0xCE, 0xEB));
		colorList.add(new ColorName("Azul ardósia", 0x6A, 0x5A, 0xCD));
		colorList.add(new ColorName("Cinza ardósia", 0x70, 0x80, 0x90));
		colorList.add(new ColorName("Branco nevve", 0xFF, 0xFA, 0xFA));
		colorList.add(new ColorName("Verde primavera", 0x00, 0xFF, 0x7F));
		colorList.add(new ColorName("Azul aço", 0x46, 0x82, 0xB4));
		...
		colorList.add(new ColorName("Tomate(vermelho médio)", 0xFF, 0x63, 0x47));
